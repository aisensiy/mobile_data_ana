...
31952300,2,,"4118","28495","116.353472","39.981827","QQ","社交沟通","SAFARI浏览器","网页浏览","20131201083955",+0000000000000005.0000,+0000000000000008.0000,+0000000000000622.0000,+0000000000004743.0000,"腾讯头像网","其他","即时聊天类","题材","即时聊天公共网站资源","http://cnzz.com/g?b=mqq&k=RfJcBw2OQbOWF6vUeHarUQ&t=1382694255&refer=mqq&s=140"
        ...
        get_domain = generate_get_right_domain(set(['qq.com', 'qlogo.cn']),
                                               ...
                                               set(['cnzz.com']))
        result = uss.domain_count_statistic(fileobj, uss.split_by_5_minute, get_domain)
        self.assertEqual([('010825', 'weixin.qq.com:3'), ('010835', 'qlogo.cn:8|weixin.qq.com:2|uu.qq.com:1'), ('010840', 'uu.qq.com:3')], result)
